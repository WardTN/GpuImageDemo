...
Java_com_example_gpuimagedemo_GPUImageNativeLibrary_YUVtoARBG(JNIEnv *env,
                                                              jclass clazz, jbyteArray yuv420sp,
...
JNIEXPORT void JNICALL
Java_com_example_gpuimagedemo_GPUImageNativeLibrary_YUVtoRBGA(JNIEnv *env, jclass clazz,
...
JNIEXPORT void JNICALL
Java_com_example_gpuimagedemo_GPUImageNativeLibrary_adjustBitmap(JNIEnv *jenv, jclass clazz,
                                                                 jobject src) {
